...
maxDepth = 2
thresholdInput = 1.0
method = "fitted_S2C_AUC_RF_" + str(thresholdInput)[0] + "_" + str(thresholdInput)[2]
...
for threshold in varyingThresholds:
    ...
    def makeROC():
        ...
        plt.savefig('1.png')
        plt.show()  
        with open('C:\\Users\\shash\\VS Code Programs\\Python\\ResearchWork\\Gastric Cancer Data\\gastricSBATCHFiles\\predictProbaScores' + str(method) + str(threshold) + '.csv','w') as csvfile:
